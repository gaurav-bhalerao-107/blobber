<template>
  <section class="index-page">
    <main class="tw-relative tw-pt-32 tw-bg-white hero-wrapper">
      <h1 class="tw-text-4xl tw-font-bold tw-tracking-tight tw-text-center sm:tw-text-5xl">Blob Generator</h1>
